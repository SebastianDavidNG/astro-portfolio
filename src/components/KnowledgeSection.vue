<template>
  <section class="relative z-10 bg-gradient-to-b from-gray-900 to-black py-20 text-white">
    <div class="max-w-6xl mx-auto px-4 text-center">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 text-left">
        ...
        >
          ...
          <p class="text-sm opacity-80 animate-type whitespace-pre-line">{{ skill.description }}</p>
          <div class="relative h-24 w-24 mx-auto mt-4">
            ...
            <div class="absolute inset-0 flex items-center justify-center text-xl font-bold text-white">{{ animatedValues[index] }}%</div>
          </div>
        </div>
      </div>
    </div>
